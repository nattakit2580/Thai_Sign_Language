    ...
    if file_path:
        ...
        while True:
            ...
            try:
                ...
                # Save the predicted image with a unique name
                predicted_image_name = f'predicted_image_{timestamp}.png'
                cv2.imwrite(predicted_image_name, image_rgb_bgr)
                print(f'Predicted image saved as {predicted_image_name}')
...
# GUI setup
root = tk.Tk()
root.title("Sign Language Prediction App")
...
# Close all OpenCV windows when GUI is closed
